...
<main class=" border rounded-lg h-[32rem] w-[20rem] bg-white p-3">
    <div class=""><img src="" alt=""></div>
    <div class="text-2xl text-center font-bold">Improve your front-end skils by building projects</div>
    <div class="text-md">Scan the QR code to visit Mentor and take your coding skills to the next level</div>
</main>
<footer class="mt-4">
